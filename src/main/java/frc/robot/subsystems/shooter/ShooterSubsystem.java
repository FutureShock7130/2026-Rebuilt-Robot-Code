...
public class ShooterSubsystem extends SubsystemBase {
    ...
    public ShooterSubsystem() {
        ...
        shooterUpConfig.CurrentLimits.StatorCurrentLimit = ShooterConstants.StatorCurrentLimit;
        shooterUpConfig.Feedback.RotorToSensorRatio = ShooterConstants.RotorToSensorRatio;
        shooterUpConfig.Feedback.SensorToMechanismRatio = ShooterConstants.SensorToMechanismRatio;
        ...
        shooterDownConfig.CurrentLimits.StatorCurrentLimit = ShooterConstants.StatorCurrentLimit;
        shooterDownConfig.Feedback.RotorToSensorRatio = ShooterConstants.RotorToSensorRatio;
        shooterDownConfig.Feedback.SensorToMechanismRatio = ShooterConstants.SensorToMechanismRatio;
        ...
        shooterAngleConfig.CurrentLimits.StatorCurrentLimit = ShooterConstants.StatorCurrentLimitAngle;
        shooterAngleConfig.Feedback.RotorToSensorRatio = ShooterConstants.RotorToSensorRatioAngle;
        shooterAngleConfig.Feedback.SensorToMechanismRatio = ShooterConstants.SensorToMechanismRatioAngle;
        ...
        shooterAngleConfig.SoftwareLimitSwitch.ForwardSoftLimitThreshold = ShooterConstants.ForwardSoftLimitThreshold;
        shooterAngleConfig.SoftwareLimitSwitch.ReverseSoftLimitThreshold = ShooterConstants.ReverseSoftLimitThreshold;
